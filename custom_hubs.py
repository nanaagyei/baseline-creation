...
def load_custom_hub(clusters, hubs):
    df = load_df()
    ...
    return site_code_dictionaries, selected_hubs, hub_baselines_df, cors_dict, df_clusters
...
# create root element
def populate_xml(site_code_dictionaries, selected_hubs, hub_baselines_df, cors_dict):
...
def map_display(site_code_dictionaries, selected_hubs, hub_baselines_df):
    filtered_map_dfs = []
